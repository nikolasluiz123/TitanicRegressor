...
class ScikitLearnMultiProcessManager:
    ...
    def __init__(self,
                 ...
                 seed: int,
                 fold_splits: int,
                 pipelines: list[ScikitLearnPipeline],
                 history_manager: HistoryManager,
    ...
    def __process_hiper_params_search(self, pipeline: ScikitLearnPipeline) -> RandomizedSearchCV | None:
    ...
    def __process_validation(self, pipeline: ScikitLearnPipeline, search_cv: RandomizedSearchCV) -> ValidationResult:
    ...
    def __save_data_in_history(self, pipeline: ScikitLearnPipeline, result: ValidationResult):
    ...
    def __append_new_result(self, pipeline: ScikitLearnPipeline, result: ValidationResult):
